 ...
 * This class is not available in the GWT client
 * @since 2.4
 */
public class BinaryResourceImpl extends ResourceImpl
{
	public static class BinaryIO extends org.eclipse.emf.ecore.resource.impl.BinaryIO {}

	public static final String OPTION_STYLE_BINARY_ENUMERATOR = BinaryIO.OPTION_STYLE_BINARY_ENUMERATOR;

	public static final String OPTION_STYLE_PROXY_ATTRIBUTES = BinaryIO.OPTION_STYLE_PROXY_ATTRIBUTES;
 
	public static final String OPTION_STYLE_BINARY_DATE = BinaryIO.OPTION_STYLE_BINARY_DATE;

	public static final String OPTION_VERSION = BinaryIO.OPTION_VERSION;
  ...
  public static class EObjectOutputStream extends BinaryIO
  {
    ...
    {
      this(outputStream, options, options != null && options.containsKey(BinaryIO.OPTION_VERSION)? (Version)options.get(BinaryIO.OPTION_VERSION) : Version.VERSION_1_1);
    }
